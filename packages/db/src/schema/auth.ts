...
/**
 * User roles. v2 ships with three portals — keep enum tight; new roles require
 * a migration anyway.
 */
 ...
 * is `role` on user.
 *
 * If you bump Better Auth and the expected schema drifts, run
 *   pnpm dlx @better-auth/cli@latest generate --config ../auth/src/index.ts
 * and reconcile.
 */
